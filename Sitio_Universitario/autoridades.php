...
<html lang="es">
	...
	<body>
		...
		<div class="prof_1">
			...
			<p>
				Dicta  el curso de <b class="prof_1" > HTML</b> y <b class="prof_1">PHP</b>
			</p>

			<p>
				Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, neque, dignissimos. Quisquam dicta, voluptates, vel molestiae, corrupti fugiat dolores vero magni aut sunt dolorem alias. Voluptatibus provident laboriosam consequuntur dolorum!
			</p>

			<p>
				Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat veritatis quas ducimus non quae natus, soluta mollitia harum. Nulla animi cumque facilis, dolores optio. Ipsa minus illo sunt mollitia, officia!
			</p>
		</div>
